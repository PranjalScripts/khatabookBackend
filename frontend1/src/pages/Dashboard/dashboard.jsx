    ...
    <div className="flex flex-row">
      ...
      <div className="p-6 bg-gray-100 min-h-screen w-full">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          <SummaryCard title="Total Balance" value="$12,750" color="bg-yellow-100" />
          <SummaryCard title="Credit" value="$5,600" color="bg-blue-100" />
          <SummaryCard title="Debit" value="$3,460" color="bg-red-100" />
        </div>
